...
export function ProductCard({ product, className }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group relative flex flex-col overflow-hidden rounded-2xl border border-border/50 bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1",
        className
      )}
    >
